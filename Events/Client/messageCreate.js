...
module.exports = {
  ...
  execute(msg) {
    ...
    try {
      if (
        !msg.member.roles.cache.has("796855972047618058") &&
        !msg.member.roles.cache.has("1027020657449521325") &&
        !msg.member.roles.cache.has("822489911331913748") &&
        !msg.member.roles.cache.has("1023742612676546560")
      ) {
